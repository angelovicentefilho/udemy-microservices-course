...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	public AuthorizationServerConfiguration(BCryptPasswordEncoder encoder, JwtTokenStore store,
			JwtAccessTokenConverter converter, AuthenticationManager authentication) {
